    ...
    <PageShell>
      ...
      <section className="py-20 bg-white">
        <div className="mx-auto max-w-7xl px-6 lg:px-10 grid md:grid-cols-3 gap-6">
          {[
            { icon: Phone, title: "Téléphone", lines: ["06 60 68 69 93", "07 66 68 27 25"], color: "magenta", href: "tel:0660686993", rot: -2 },
            { icon: Mail, title: "Email", lines: ["contact@educazenkids.ma"], color: "purple", href: "mailto:contact@educazenkids.ma", rot: 2 },
            { icon: MapPin, title: "Adresse", lines: ["Agadir, Maroc"], color: "teal", href: "#map", rot: -1 },
          ].map((c, i) => (
            <motion.a
              key={c.title}
              href={c.href}
